...
mkdir -p "$HOME/.config/opencode/codexpowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/codexpowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/codexpowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/codexpowers/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/codexpowers.js" "$HOME/.config/opencode/codexpowers/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/codexpowers/.opencode/plugins/codexpowers.js" \
       "$HOME/.config/opencode/plugins/codexpowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/codexpowers/.opencode/plugins/codexpowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/codexpowers.js"
