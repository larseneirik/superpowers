...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/codexpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/codexpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using codexpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
